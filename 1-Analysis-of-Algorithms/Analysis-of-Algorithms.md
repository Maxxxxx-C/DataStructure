...
![记号](https://latex.codecogs.com/svg.image?T(n)=4T(n/2)+n)

**假设** ![记号](https://latex.codecogs.com/svg.image?T(n)=O(n^3))

`大O记号不能用于数学归纳，首先要化为线性形式`

证明 ![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant cn^3)

假设成立，则 ![记号](https://latex.codecogs.com/svg.image?T(n)=4T(n/2)+n\leqslant4c(n/2)^3+n)

即 ![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant cn^3/2+n)

![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant cn^3-(cn^3/2-n))

其中，![记号](https://latex.codecogs.com/svg.image?\forall (c\geqslant2,n\geqslant1),cn^3/2-n\geqslant0)

因此此时，![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant cn^3)，假设成立
...
证明 ![记号](https://latex.codecogs.com/svg.image?T(k)\leqslant c_{1}n^2-c_{2}n)

假设不等式成立，则 ![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant4c_{1}(n/2)^2-4c_{2}(n/2)+n)

即 ![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant c_{1}n^2-2c_{2}n+n)

![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant c_{1}n^2-c_{2}n-(c_{2}-1)n)

其中，![记号](https://latex.codecogs.com/svg.image?\forall (c_{2}\geqslant1,n\geqslant0),(c_{2}-1)n\geqslant0)

因此此时，![记号](https://latex.codecogs.com/svg.image?T(n)\leqslant c_{1}n^2-c_{2}n)，假设成立
...
![记号](https://latex.codecogs.com/svg.image?T(n)=T(n/4)+T(n/2)+n^2)
...
对每一级求和发现，第1+k层的叶节点的和为 ![记号](https://latex.codecogs.com/svg.image?\frac{5^k}{16^k}n^2)，树的层数是![记号](https://latex.codecogs.com/svg.image?1+\log_{4}n)
...
显然，![记号](https://latex.codecogs.com/svg.image?T(n)\geqslant n^2)
...
形式符合 ![记号](https://latex.codecogs.com/svg.image?T(n)=aT(n/b)+f(n))，其中 ![记号](https://latex.codecogs.com/svg.image?a\geqslant1,b>0)，并且 ![记号](https://latex.codecogs.com/svg.image?f(n)) 是渐近趋正的
